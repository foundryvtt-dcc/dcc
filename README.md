...
* [V14 Reference](docs/dev/V14.md) - FoundryVTT V14 data models, Active Effects V2, and API changes
* [V13 / ApplicationV2 Reference](docs/dev/V13.md) - ApplicationV2 patterns used by all sheets and dialogs

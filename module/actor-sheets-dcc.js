...
class DCCActorSheetCleric extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Cleric"}}
...
class DCCActorSheetThief extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Thief"}}
...
class DCCActorSheetHalfling extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Halfling"}}
...
class DCCActorSheetWarrior extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Warrior"}}
...
class DCCActorSheetWizard extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Wizard"}}
...
class DCCActorSheetDwarf extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Dwarf"}}
...
class DCCActorSheetElf extends DCCActorSheet {
  ...
  getData () {
    ...
    data.data.class.className = {{localize "DCC.Elf"}}

 ...
 * release can actually carry forward. Worlds in the `[0.22, 0.70)` band are
...
describe('classifyMigrationDecision', () => {
  test('exported floor + ceiling constants', () => {
    ...
    expect(NEEDS_MIGRATION_VERSION).toBe(0.70)
  })
  ...
  test('already migrated (0.70) skips', () => {
    expect(classifyMigrationDecision(0.70)).toBe('skip')
  })

 ...
 */
export declare function meetsFumbleRange(result: RollResult, fumbleRange?: number): boolean;
/**
 ...
 */
export declare function meetsThreatRange(result: RollResult, threatRange: number, isNatural?: boolean): boolean;
/**
